        ...
        <div class="sidebar sidebar-dark sidebar-left bg-dark-gray" data-perfect-scrollbar>
            ...
            <div class="d-flex align-items-center sidebar-p-a sidebar-account flex-shrink-0">
                <a href="index.html" class="flex d-flex align-items-center text-underline-0">
                    ...
                    <span class="flex d-flex flex-column">
                        <span class="sidebar-brand">Makerere Business</span>
            ...
            <div class="sidebar-block p-0">
                <ul class="sidebar-menu mt-0">
                    ...
                    @if (
                        ...
                        @if (
                            ...
                            <li class="sidebar-menu-item">
                                <a class="sidebar-menu-button" href="{{ route('admin.auth.user.index') }}">
                        ...
                        @if ($logged_in_user->hasAllAccess())
                            <li class="sidebar-menu-item">
                                <a class="sidebar-menu-button" href="{{ route('admin.auth.role.index') }}">
                    ...
                    @if ($logged_in_user->hasAllAccess())
                        <li class="sidebar-menu-item">
                            <a class="sidebar-menu-button" href="{{ route('log-viewer::dashboard') }}">
                                <i class="sidebar-menu-icon sidebar-menu-icon--left material-icons">star_half</i>
                                <span class="sidebar-menu-text">Log Dashboard</span>
                            </a>
                        </li>
                        <li class="sidebar-menu-item">
                            <a class="sidebar-menu-button" href="{{ route('log-viewer::logs.list') }}">

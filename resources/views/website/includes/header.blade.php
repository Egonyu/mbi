      ...
      <div class="container pt-0 pb-0">
        <div class="row">
          <div class="col-xs-12 col-sm-4 col-md-5">
            <div class="widget no-border m-0">
              <a class="menuzord-brand pull-left flip xs-pull-center mb-15" href="javascript:void(0)"><img src="{{ asset('frontend/images/logo-wide.png') }}" alt=""></a>
            </div>
          </div>
        ...
        <div class="container">
          <nav id="menuzord" class="menuzord bg-theme-colored pull-left flip menuzord-responsive">
              <ul class="menuzord-menu">
                ...
                <li><a href="#">Register <span class="label label-info">New</span></a></li>
            ...
            <ul class="pull-right flip hidden-sm hidden-xs">
              <li>
                <!-- Modal: Book Now Starts -->
                    ...
                    <li><a class="btn btn-colored btn-flat bg-theme-color-2 text-white font-14 bs-modal-ajax-load mt-0 p-25 pr-15 pl-15" href="{{ route('frontend.user.account') }}">@lang('Account')</a></li>
                <!-- Modal: Book Now End -->
              </li>
            </ul>
